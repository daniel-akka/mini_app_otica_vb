Public Class ClAReceberTotal
    ...
    Public Property art_idficha_otica As Int64
    Public Property art_parcela As Int32
    ...
    Sub New(Optional ByVal id As Int64 = 0, Optional ByVal empresaid As Integer = 0, Optional ByVal empresanome As String = "", _
            ...
            Optional ByVal idvendaproduto As Int64 = 0, Optional ByVal idfichaotica As Int64 = 0, Optional ByVal parcela As Int32 = 1)
        ...
        Me.art_idficha_otica = idfichaotica
        Me.art_parcela = parcela
    End Sub
    ...
    Sub New(AReceberTotal As ClAReceberTotal)
        ...
        With Me
            ...
            .art_idficha_otica = AReceberTotal.art_idficha_otica
            .art_parcela = AReceberTotal.art_parcela
