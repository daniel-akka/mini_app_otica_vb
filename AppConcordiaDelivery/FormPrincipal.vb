...
Public Class FormPrincipal
    ...
    Sub TrazObjetos()
        ...
        'Ótica:
        Dim DaoFichaOtica As New ClFichaOticaDAO
        Dim DaoFichaOticaProduto As New ClFichaOticaProdutoDAO
        Dim DaoFichaOticaOlho As New ClFichaOticaOlhoDAO
        Dim DaoFichaOticaPrestacoes As New ClFichaOticaPrestacoesDAO
        Dim DaoFichaOticaAssinatura As New ClFichaOticaAssinaturaDAO
        ...
        'Traz Listas da Ótica:
        DaoFichaOtica.TrazListFichaOtica_BD(MdlConexaoBD.ListaFichaOtica, MdlConexaoBD.conectionPadrao)
        DaoFichaOticaProduto.TrazListFichaOticaProduto_BD(MdlConexaoBD.ListaFichaOticaProduto, MdlConexaoBD.conectionPadrao)
        DaoFichaOticaOlho.TrazListFichaOticaOlho_BD(MdlConexaoBD.ListaFichaOticaOlho, MdlConexaoBD.conectionPadrao)
        DaoFichaOticaPrestacoes.TrazListFichaOticaPrestacoes_BD(MdlConexaoBD.ListaFichaOticaPrestacoes, MdlConexaoBD.conectionPadrao)
        DaoFichaOticaAssinatura.TrazListFichaOticaAssinatura_BD(MdlConexaoBD.ListaFIchaOticaAssinatura, MdlConexaoBD.conectionPadrao)
    End Sub
    ...
    Private Sub FormPrincipal_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        ...
        Select Case e.KeyCode
            ...
            Case Keys.F3
                ...
                'frmServicos = Nothing
                Dim formulario As New FrmCadProduto
                formulario.ShowDialog()
                formulario = Nothing
    ...
    Private Sub FichaÓticaToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles FichaÓticaToolStripMenuItem.Click
        Dim mFormulario As New FormFichaOtica
        mFormulario.ShowDialog()
        mFormulario = Nothing
    End Sub
End Class
