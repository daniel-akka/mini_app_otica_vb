...
#Region "Funcoes"
    ...
    Sub executaF11()
        ...
        ClienteDAO.TrazListClientes(_ListaClientes, MdlConexaoBD.conectionPadrao)
    ...
    Private Sub preencheDtgClientees()
    ...
    Sub ExecutaF3()
        ...
        If dtg_clientes.CurrentRow.IsNewRow = False Then
            ...
            Cliente.ZeraValores()
            Cliente = New ClCliente(MdlConexaoBD.mdlListClientes.Find(Function(c As ClCliente) c.cid = mID))
            HabilitaCampos()
            ...
            If dtg_clientes.CurrentRow.IsNewRow = False Then
                ...
                If MessageBox.Show(mMsg, Application.CompanyName, MessageBoxButtons.YesNo, MessageBoxIcon.Question) _
                    ...
                    Try
                        ...
                        ClienteDAO.TrazListClientes(MdlConexaoBD.mdlListClientes, MdlConexaoBD.conectionPadrao)
                        ExecutaF5()
                        Cliente.ZeraValores()
