Module MdlConexaoBD
    ...
    'Ótica:
    Public ListaFichaOtica As New List(Of ClFichaOtica)
    Public ListaFichaOticaProduto As New List(Of ClFichaOticaProduto)
    Public ListaFichaOticaOlho As New List(Of ClFichaOticaOlho)
    Public ListaFichaOticaPrestacoes As New List(Of ClFichaOticaPrestacoes)
    Public ListaFIchaOticaAssinatura As New List(Of ClFichaOticaAssinatura)
