...
Public Class FrmCadAtendente
    ...
    Private Sub btnSalvar_Click(sender As Object, e As EventArgs) Handles btnSalvar.Click
        ...
        Try
            ...
            _atendenteDao.TrazListAtendentes_BD(MdlConexaoBD.ListaAtendentes, MdlConexaoBD.conectionPadrao)
    ...
    Sub ExecutaF5()
        ...
        _atendenteDao.PreencheCboAtendentesLista(CboAtendente, ListaAtendentes)
    End Sub
