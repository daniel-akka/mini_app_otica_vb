...
Public Class FrmCadFornecedor
    ...
    Dim _listaFornPesq As New List(Of ClFornecedor)
...
#Region "Funcoes"
    ...
    Sub ExecutaF5()
        ...
        _listaFornPesq.Clear()
        _listaFornPesq = MdlConexaoBD.ListaFornecedores.FindAll(Function(f As ClFornecedor) f.pNome.StartsWith(Me.txt_pesquisa.Text))
        If _listaFornPesq.Count < 1 Then Return
        For Each f As ClFornecedor In _listaFornPesq

            dtg_fornecedores.Rows.Add(f.pId, f.pNome, f.pfTelefone, f.pEndereco, f.pCidade)
        Next
        txt_qtdRegistros.Text = _listaFornPesq.Count
            ...
            If dtg_fornecedores.CurrentRow.IsNewRow = False Then
                ...
                If MessageBox.Show("Deseja Realmente Deletar esse FORNECEDOR ?", Application.ProductName, MessageBoxButtons.YesNo, MessageBoxIcon.Question) _
                    ...
                    Try
                        ...
                        fornecedorDAO.TrazListFornecedoresBD(MdlConexaoBD.ListaFornecedores, MdlConexaoBD.conectionPadrao)
                    Catch ex As Exception
