...
Public Class FrmCadServicos
    ...
    Private Sub FrmCadServico_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        _ProdutoDAO.PreencheCboProdutosLista(cboProdutoUsado, MdlConexaoBD.mdlListProdutos)
        _AtendenteDAO.PreencheCboAtendentesListaPesquisa(cboAtendente, MdlConexaoBD.mdlListAtendentes)
    ...
    Private Sub btnSalvar_Click(sender As Object, e As EventArgs) Handles btnSalvar.Click
        ...
        Try
            ...
            _ServicoDao.TrazListServicos(MdlConexaoBD.mdlListServicos, MdlConexaoBD.conectionPadrao)
    ...
    Private Sub cboProdutoUsado_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboProdutoUsado.SelectedIndexChanged
        ...
        If cboProdutoUsado.SelectedIndex > -1 Then
            ...
            _ProdutoDAO.TrazProdutoDaListaPorID(_Produto, MdlConexaoBD.mdlListProdutos)
