        ...
        If _ListaAReceberTotal.Count > 0 Then
            ...
            For Each ar As ClAReceberTotal In _ListaAReceberTotal
                ...
                dtgContasAReceber.Rows.Add(False, ar.art_id, ar.art_clienteid, ar.art_clientenome, ar.art_tela, ar.art_situacao, _
                                           ar.art_dataemissao.ToShortDateString, ar.art_valor.ToString("#,##0.00"), ar.art_datavencimento.ToShortDateString, ar.art_valorrestante.ToString("#,##0.00"), mDataPagamento, mDias, ar.art_acrescimo.ToString("#,##0.00"), ar.art_observacao)
            Next
        End If
